        ...
        <form className="report-form" onSubmit={handleSubmit}>
          ...
          {formData.trips.map((t, i) => (
            <div key={i} className="form-row">
              <input
                placeholder="De"
                value={t.from}
                onChange={(e) => handleArrayChange(e, i, "from", "trips")}
              />
              <input
                placeholder="Até"
                value={t.to}
                onChange={(e) => handleArrayChange(e, i, "to", "trips")}
              />
              <input
                placeholder="KM"
                value={t.km}
                onChange={(e) => handleArrayChange(e, i, "km", "trips")}
              />
              <input
                placeholder="Horas"
                value={t.hours}
              ...
              />
              <button type="button" onClick={() => removeRow("trips", i)}>
                Remover
              </button>
            </div>
          ))}
          ...
          {formData.materials.map((m, i) => (
            <div key={i} className="form-row">
              <input
                placeholder="Quant."
                value={m.qty}
                onChange={(e) => handleArrayChange(e, i, "qty", "materials")}
              />
              <input
              ...
              />
              <button type="button" onClick={() => removeRow("materials", i)}>
                Remover
              </button>
            </div>
          ))}
          ...
          <label>
            ...
            >
              ...
              <option value="billable">A faturar</option>
            </select>
          </label>
